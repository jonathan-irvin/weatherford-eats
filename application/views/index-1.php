              ...
              <div style="width: 100%; margin:0 auto; padding:0; position:relative;"> <!-- define slider container width (strict enforce) -->
                <div class="slider-wrapper theme-default">
                  <div id="slider" class="nivoSlider"> 
                    ...
                    <!-- Slide 1 --> 
                    <img src="http://cdn.pimg.co/p/960x380/123321/fff/img.png"  title="#htmlcaption1" /> 
                    
                    <!-- Slide 2 --> 
                    <img src="http://cdn.pimg.co/p/960x380/777ggg/fff/img.png"  title="#htmlcaption2" /> 
                    
                    <!-- Slide 3 --> 
                    <img src="http://cdn.pimg.co/p/960x380/111333/fff/img.png" /> </div>
                  <!-- /slider --> 
