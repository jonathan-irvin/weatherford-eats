        ...
        <div class="cont">
          ...
          <div class="now_page">
            <div class="now_page_resize">
              <h1>404 Error<span>Cras sit amet libero eros... </span></h1>
              <div class="clr"></div>
            </div>
            <div class="clr"></div>
          </div>
            ...
            <div class="content_resize">
              <div class="content_page">
                <div class="content_full_size">
                  <div class="p404">
                    <h2><em class="p404_h2_second_color">Not found</em><br />
                      <span><em class="p404_h2_second_color">Oops, this page can't be found!</em></span></h2>
                    <p>We are sorry but the page you are looking for does not exist. <br />
                      You could return to the <a href="index.html">homepage</a></p>
                  </div>
                </div>
                <div class="clr"></div>
              </div>
