...
$(function(){
...

	{
        ...
        jQuery('#jFancyTile').width('420');
		jQuery('#image1').attr('src','http://cdn.pimg.co/p/405x180/123321/fff/img.png');
		jQuery('#image2').attr('src','http://cdn.pimg.co/p/405x180/321321/fff/img.png');
		jQuery('#image3').attr('src','http://cdn.pimg.co/p/405x180/777ggg/fff/img.png');
		jQuery('#image4').attr('src','http://cdn.pimg.co/p/405x180/789987/fff/img.png');
	    jQuery('#image5').attr('src','http://cdn.pimg.co/p/405x180/600666/fff/img.png'); 
		jQuery('#image6').attr('src','http://cdn.pimg.co/p/405x180/111333/fff/img.png'); 
		jQuery('#image7').attr('src','http://cdn.pimg.co/p/405x180/999999/fff/img.png'); 
	    <!-- DC jFancyTile Slider JS -->
...

	{
       	...
       	<!-- DC jFancyTile Slider JS -->
        jQuery('#jFancyTile').width('300');
		jQuery('#image1').attr('src','http://cdn.pimg.co/p/285x135/123321/fff/img.png');
		jQuery('#image2').attr('src','http://cdn.pimg.co/p/285x135/321321/fff/img.png');
		jQuery('#image3').attr('src','http://cdn.pimg.co/p/285x135/777ggg/fff/img.png');
		jQuery('#image4').attr('src','http://cdn.pimg.co/p/285x135/789987/fff/img.png');
	    jQuery('#image5').attr('src','http://cdn.pimg.co/p/285x135/600666/fff/img.png'); 
		jQuery('#image6').attr('src','http://cdn.pimg.co/p/285x135/111333/fff/img.png'); 
		jQuery('#image7').attr('src','http://cdn.pimg.co/p/285x135/999999/fff/img.png'); 
	    <!-- DC jFancyTile Slider JS -->
	 ...
	 {
       	<!-- DC jFancyTile Slider JS -->
        jQuery('#jFancyTile').width('767');
		jQuery('#image1').attr('src','http://cdn.pimg.co/p/755x274/123321/fff/img.png');
		jQuery('#image2').attr('src','http://cdn.pimg.co/p/755x274/321321/fff/img.png');
		jQuery('#image3').attr('src','http://cdn.pimg.co/p/755x274/777ggg/fff/img.png');
		jQuery('#image4').attr('src','http://cdn.pimg.co/p/755x274/789987/fff/img.png');
	    jQuery('#image5').attr('src','http://cdn.pimg.co/p/755x274/600666/fff/img.png'); 
		jQuery('#image6').attr('src','http://cdn.pimg.co/p/755x274/111333/fff/img.png'); 
		jQuery('#image7').attr('src','http://cdn.pimg.co/p/755x274/999999/fff/img.png'); 
	    <!-- DC jFancyTile Slider JS -->
        ...
        <div class="container">
          <div class="cont">
            ...
            <div id="now_slider" class="gap2"> 
              ...
              <div id="jFancyTile" style="width:960px;margin:0 auto; position:relative;"> <!-- define slider container width (strict enforce) --> 
                ...
                <section id="slide">
                  <div id="fancytile-slide">
                    ...
                    <li><img src="dcodes/sliders/images/jfancytile/950x420-image.jpg" alt="#caption-one" width="950" height="420" /> --> 
                      ...
                      <!-- Slide 1 -->
                      <li><img src="http://cdn.pimg.co/p/944x410/123321/fff/img.png" alt="#caption-one" id="image1" width="944" height="410" />
                      ...
                      <!-- Slide 2 -->
                      <li><img src="http://cdn.pimg.co/p/944x410/321321/fff/img.png" alt="#caption-two" id="image2" width="944" height="410" />
                        <div class="html-caption">
                      ...
                      <!-- Slide 3 -->
                      <li><img src="http://cdn.pimg.co/p/944x410/777ggg/fff/img.png" alt="#caption-three" id="image3" width="944" height="410"/>
                        <div class="html-caption">
                          <div class="caption-head">Aliquam consectetuer vivamus</div>
                          <div class="text-capt">
                            <p>Dui hendrerit pellentesque lorem rutrum tellus fringilla feugiat. Interdum erat porta libero. Ullamcorper turpis sed lobortis. Vitae integer libero amet.</p>
                      ...
                      <!-- Slide 4 -->
                      <li><img src="http://cdn.pimg.co/p/944x410/789987/fff/img.png" alt="#caption-four" id="image4" width="944" height="410" />
                        <div class="html-caption">
                      ...
                      <!-- Slide 5 -->
                      <li><img src="http://cdn.pimg.co/p/944x410/600666/fff/img.png" alt="#caption-five" id="image5" width="944" height="410"/>
                        <div class="html-caption">
                      ...
                      <!-- Slide 6 -->
                      <li><img src="http://cdn.pimg.co/p/944x410/111333/fff/img.png" alt="#caption-six" id="image6" width="944" height="410" />
                        <div class="html-caption">
                      ...
                      <!-- Slide 7 -->
                      <li><img src="http://cdn.pimg.co/p/944x410/999999/fff/img.png" alt="#caption-seven" id="image7" width="944" height="410" />
                        <div class="html-caption">
