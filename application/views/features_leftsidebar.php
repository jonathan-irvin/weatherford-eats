        ...
        <div class="cont">
          ...
          <div class="now_page">
            <div class="now_page_resize">
              <h1>Left Sidebar Page<span>Cras sit amet libero eros... </span></h1>
              <div class="clr"></div>
            </div>
            <div class="clr"></div>
          </div>
          ...
          <div class="content" id="gallery">
            <div class="content_resize">
              <div class="content_page">
                <div class="columns1">
                  <div class="one-third column alpha gap20">
                    <div class="sidebar ">
                  ...
                  <div class="two-thirds column omega">
                    <div class="centercol">
                      ...
                      <div class="content_full_size">
                        ...
                        <div class="pic fl img_hover_box gap4"> <a href="http://cdn.pimg.co/p/800x600/84586f/fff/img.png" class="prettyPhoto" rel="prettyPhoto[id]"><img src="http://cdn.pimg.co/p/256x216/84586f/fff/img.png" width="256" height="216" alt="Image" />
                          <div class="img_hover_overlay">
                            <div class="r_plus"></div>
                          </div>
                          </a></div>
                      ...
                      <div class="content_full_size">
                        ...
                        <div class="pic img_hover_box"> <a href="http://cdn.pimg.co/p/800x600/419482/fff/img.png" class="prettyPhoto" rel="prettyPhoto[id]"><img src="http://cdn.pimg.co/p/620x216/419482/fff/img.png" width="620" height="216" alt="Image" />
                          <div class="img_hover_overlay">
                            <div class="r_plus"></div>
                          </div>
                          </a></div>
                          ...
                          <div class="one-third column alpha">
                            <div class="col2 cols_no_bg">
                              <div class="div_h3_act_href ico_1">
                                ...
                                <p class="detail">Tunc lacrimas illa benignissime vi aureo in lucem exempli .</p>
                              </div>
                            </div>
                          </div>
                          <div class="one-third column omega">
                            <div class="col2 cols_no_bg last">
                              <div class="div_h3_act_href ico_2">
                                <h3><a href="#"><em>Modern Layout</em></a></h3>
                                <p class="detail">Meam ad suis caelo in lucem exitum vivit in lucem em vivit.</p>
                              </div>
                            </div>
                          </div>
                          <div class="clr"></div>
                          ...
                          <div class="one-third column alpha">
                            <div class="col2 cols_no_bg">
                              <div class="div_h3_act_href ico_3">
                                ...
                                <p class="detail">Pellentesque rutrum auctor vulputate. Sed consequat suscipit. </p>
                              </div>
                            </div>
                          </div>
                          <div class="one-third column omega">
                  ...
                  <div class="one-third column alpha gap21">
                    <div class="sidebar ">
                      <div class="sidebar_content">
                        <div class="sidebar_pop_posts">
                          <div class="sidebar_bg">
