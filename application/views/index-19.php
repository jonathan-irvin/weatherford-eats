...
<link rel="stylesheet" type="text/css" href="css/skitter/skitter.styles.css" />

<!-- DC Skitter Slider JS -->
<!-- requires jquery library -->
<!-- requires easing library -->
<script src="js/jquery.easing.js" type="text/javascript"></script>
<script type="text/javascript" src="sliders/skitter/jquery.skitter.min.js"></script>
<script type="text/javascript" src="sliders/skitter/jquery.animate-colors-min.js"></script>
    ...
    $('.box_skitter_large').skitter(
{
    ...
    if(rwidth >959) 
	{
		 $('.box_skitter_large').width('940'); 
	}
	else if(rwidth >= 480 && rwidth <= 767) $('.box_skitter_large').width('420'); 
	else if(rwidth <= 479) $('.box_skitter_large').width('300'); 
	else if(rwidth >= 768 && rwidth <= 959) $('.box_skitter_large').width('768');*/
});
</script>
              ...
              <div style=" width: 100%; margin:0 auto; padding: 0; position:relative;"> <!-- define slider container width (strict enforce) -->
                ...
                <div class="box_skitter box_skitter_large">
                  <ul>
                    ...
                    <!-- sample local image: 
                <!-- <li> <a href="#"><img src=""dcodes/sliders/images/skitter/980x400-image.jpg" class="block" width="980" height="400" /></a> --> 
                    
                    <!-- Slide 1 -->
                    <li> <a href="http://www.dcodes.net"> <img src="http://cdn.pimg.co/p/960x400/123321/fff/img.png" id="image1" class="block" /> </a>
                    ...
                    <!-- Slide 2 -->
                    <li> <a href="#"><img src="http://cdn.pimg.co/p/960x400/777ggg/fff/img.png" id="image2" class="cube" /></a>
                      <div class="label_text">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                      </div>
                    </li>
                    ...
                    <!-- Slide 3 -->
                    <li> <a href="http://jquery.com"><img src="http://cdn.pimg.co/p/960x400/600666/fff/img.png" id="image3" class="default" /></a>
                      <div class="label_text">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                      </div>
                    </li>
                    ...
                    <!-- Slide 4 -->
                    <li> <a href="http://jquery.com"><img src="http://cdn.pimg.co/p/960x400/111333/fff/img.png" id="image4" class="paralell" /></a>
                      <div class="label_text">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                      </div>
                    </li>
                    ...
                    <!-- Slide 5 -->
                    <li> <a href="http://jquery.com"><img src="http://cdn.pimg.co/p/960x400/321321/fff/img.png" id="image5" class="random" /></a>
                      <div class="label_text">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                      </div>
                    </li>
                  ...
                  <!-- navigation controls --> 
                  <a style="display: block; opacity: 0.6;" href="#" class="prev_button">prev</a><a style="display: block; opacity: 0.6;" href="#" class="next_button">next</a> </div>
                <!-- /box_skitter --> 
              </div>
