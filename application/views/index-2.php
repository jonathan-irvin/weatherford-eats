...
<link rel="stylesheet" id="camera-css"  href="sliders/camera/css/camera.css" type="text/css" media="all">
<script type="text/javascript" src="sliders/camera/js/jquery.mobile.customized.min.js"></script>
<script type="text/javascript" src="sliders/camera/js/jquery.easing.1.3.js"></script>
<script type="text/javascript" src="sliders/camera/js/camera.min.js"></script>
<script type="text/javascript">
	jQuery(function(){		 
            ...
            <div id="now_slider"> 
              ...
              <div style="margin:0 auto; "> <!-- define slider container width (strict enforce) -->
                <div class="camera_wrap camera_azure_skin" id="camera_wrap_1"> 
                  <!-- Slide 1 -->
                  <div data-thumb="http://cdn.pimg.co/p/100x75/123321/fff/img.png" data-src="http://cdn.pimg.co/p/960x380/123321/fff/img.png">
                    <div class="camera_caption fadeFromBottom"> <a href="#">Camera</a> is a responsive/adaptive slideshow. <em>Try to resize the browser window</em> </div>
                  </div>
                  <!-- Slide 2 -->
                  <div data-thumb="http://cdn.pimg.co/p/100x75/321321/fff/img.png" data-src="http://cdn.pimg.co/p/960x380/321321/fff/img.png">
                    <div class="camera_caption fadeFromBottom"> It uses a light version of <a href="#">jQuery</a> mobile, <em>navigate the slides by swiping with your fingers</em> </div>
                  </div>
                  <!-- Slide 3 -->
                  <div data-thumb="http://cdn.pimg.co/p/100x75/777ggg/fff/img.png" data-src="http://cdn.pimg.co/p/960x380/777ggg/fff/img.png">
                    <div class="camera_caption fadeFromBottom"> <a href="#">Camera slideshow</a> provides many options <em>to customize your project</em> as more as possible </div>
                  </div>
                  <!-- Slide 4 -->
                  <div data-thumb="http://cdn.pimg.co/p/100x75/789987/fff/img.png" data-src="http://cdn.pimg.co/p/960x380/789987/fff/img.png">
                    <div class="camera_caption fadeFromBottom"> Different color <a href="#">skins</a> and layouts available, <em>fullscreen ready too</em> </div>
                  </div>
                </div>
                <!-- /camera_wrap --> 
              </div>
