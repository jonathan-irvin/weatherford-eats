...
<link rel="stylesheet" type="text/css" href="css/broken-glass/slider-brokenglass-style.css" />

<!-- DC Broken Glass Slider JS -->
<!-- requires jquery library -->
<script type="text/javascript" src="sliders/broken-glass/jquery.transform-0.9.3.min_.js"></script>
<script type="text/javascript" src="sliders/broken-glass/jquery.mousewheel.js"></script>
<script type="text/javascript" src="sliders/broken-glass/jquery.RotateImageMenu.js"></script>
<script type="text/javascript">
$(window).resize(function(){
	var rwidth=$(this).width();
     if(rwidth >959)
	 { 
	    $('#panel-1').attr('data-rotation','-12');
		$('#panel-2').attr('data-rotation','-5');
		$('#panel-3').attr('data-rotation','5');
		$('#panel-4').attr('data-rotation','24');
	 }
	else if(rwidth >= 480 && rwidth <= 767)
	{
		//420
		$('#panel-1').attr('data-rotation','-10');
		$('#panel-2').attr('data-rotation','-3');
		$('#panel-3').attr('data-rotation','3');
		$('#panel-4').attr('data-rotation','10');
	}
              ...
              <div style="width:100%; margin:0 auto; padding:0; position:relative;"> <!-- define slider container width (strict enforce) -->
                <div id="rm_container" class="rm_container">
                  <ul>
                    ...
                    <li id="panel-1" data-images="rm_container_1" data-rotation="-12"><img src="http://cdn.pimg.co/p/379x470/111333/fff/img.png" width="379" height="470" /></li>
                    <li id="panel-2" data-images="rm_container_2" data-rotation="-5"><img src="http://cdn.pimg.co/p/379x470/777ggg/fff/img.png" width="379" height="470" /></li>
                    <li id="panel-3" data-images="rm_container_3" data-rotation="5"><img src="http://cdn.pimg.co/p/379x470/789987/fff/img.png" width="379" height="470" /></li>
                    <li id="panel-4" data-images="rm_container_4" data-rotation="13"><img src="http://cdn.pimg.co/p/379x470/123321/fff/img.png" width="379" height="470" /></li>
                  </ul>
                  ...
                  <div style="display:none;">
                    <div id="rm_container_1"> <img src="http://cdn.pimg.co/p/379x470/789987/fff/img.png" width="379" height="470" /> <img src="http://cdn.pimg.co/p/379x470/321321/fff/img.png" width="379" height="470" /> </div>
                    <div id="rm_container_2"> <img src="http://cdn.pimg.co/p/379x470/111333/fff/img.png" width="379" height="470" /> <img src="http://cdn.pimg.co/p/379x470/111333/fff/img.png" width="379" height="470" /> </div>
                    <div id="rm_container_3"> <img src="hhttp://cdn.pimg.co/p/379x470/789987/fff/img.png" width="379" height="470" /> <img src="http://cdn.pimg.co/p/379x470/111333/fff/img.png" width="379" height="470" /> </div>
                    <div id="rm_container_4"> <img src="http://cdn.pimg.co/p/379x470/321321/fff/img.png" width="379" height="470" /> <img src="http://cdn.pimg.co/p/379x470/600666/fff/img.png" width="379" height="470" /> </div>
                  </div>
                </div>
                <!-- /rm_container --> 
